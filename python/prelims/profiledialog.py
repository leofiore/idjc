...
class ProfileDialog(Gtk.Dialog):
    ...
    def __init__(self, default, data_function=None):
        ...
        GObject.GObject.__init__(self, _("IDJC Profile Manager"))
        ...
        c1.pack_start(pbrend, False, True, 0)
        c1.pack_start(strrend, True, True, 0)
        ...
        c4.pack_start(ledrend, True, True, 0)
        c4.pack_start(time_rend, True, True, 0)
